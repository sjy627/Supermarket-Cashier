...
public class Goods {
  ...
  private Integer stockReorderPoint;
  ...
  public Integer getStockWarningThreshold() {
    return stockWarningThreshold;
  }

  public void setStockWarningThreshold(Integer stockWarningThreshold) {
    this.stockWarningThreshold = stockWarningThreshold;
  }

  public Integer getStockReorderPoint() {
    return stockReorderPoint;
  }

  public void setStockReorderPoint(Integer stockReorderPoint) {
    this.stockReorderPoint = stockReorderPoint;
  }
