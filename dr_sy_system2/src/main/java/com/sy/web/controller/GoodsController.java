...
public class GoodsController {
    ...
    @RequestMapping("/goods/lowStock")
    @ResponseBody
    public ResultDto<Object> getLowStockGoods(){
        return goodsServiceImpl.getLowStockGoods();
    }

    @RequestMapping("/goods/reorder")
    @ResponseBody
    public ResultDto<Object> getReorderGoods(){
        return goodsServiceImpl.getReorderGoods();
    }

    @RequestMapping("/goods/updateStock")
    @ResponseBody
    public ResultDto<Object> updateGoodsStock(Goods goods){
        return goodsServiceImpl.updateGoodsStock(goods);
    }

    @RequestMapping("/goods/stockWarningStats")
    @ResponseBody
    public ResultDto<Object> getStockWarningStats(){
        return goodsServiceImpl.getStockWarningStats();
    }

    @RequestMapping("/goods/warningPage")
    public String warningPage(){
        return "goods/goods-warning";
    }
}
